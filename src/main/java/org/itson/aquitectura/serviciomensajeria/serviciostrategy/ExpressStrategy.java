...
/**
 * Esta clase permite devolver el coste del servicio Express.
 *
 * @author Víctor Humberto Encinas Guzmán
 */
public class ExpressStrategy implements ServicioStrategy{

    private final double COSTO_BASE = 50.0;
    private final double COSTO_KM = 5.0;
    
    /**
     * Método que nos permite obtener el costo del servicio Express.
     *
